...
Carousel.prototype.init = function () {
	var items, that, startPoint, startEle, curPoint, distance = 0, touchTimer = []
...
Carousel.prototype.showNav = function () {
	...
	[].slice.call(this.ele.getElementsByClassName('navigation_index')).forEach( (ele, i) => {
